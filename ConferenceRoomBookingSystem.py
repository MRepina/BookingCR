...
def show_day():
    ...
    # Destroy the current root widgets
    ...
    def go_back_to_main_menu():
        # Destroy the book_frame and create the main menu again
        book_frame.destroy()
        create_main_menu()
...
def show_week():
    ...
    def go_back_to_main_menu():
        # Destroy the book_window and create the main menu again
        book_frame.destroy()
        create_main_menu()
...
def create_main_menu():
    ...
    main_frame = tk.CTkScrollableFrame(master=root, width=200, height=200)
    main_frame.pack(pady=20, padx=60, fill="both", expand=True)
    
    # Create the four buttons
    button1 = tk.CTkButton(master=main_frame, text="Schedule for a day", command=show_day)
    button1.pack(pady=12, padx=10)

    button2 = tk.CTkButton(master=main_frame, text="Schedule for a week", command=show_week)
    button2.pack(pady=12, padx=10)

    button3 = tk.CTkButton(master=main_frame, text="Booking", command=book_time)
